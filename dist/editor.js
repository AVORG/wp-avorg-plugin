...
/***/ "./component/molecule/mediaIdMetaBox/index.tsx":
/*!*****************************************************!*\
  !*** ./component/molecule/mediaIdMetaBox/index.tsx ***!
  \*****************************************************/
/*! no static exports found */
...
var AvorgMoleculeMediaIdMetaBox;
(function (AvorgMoleculeMediaIdMetaBox) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_highlight_words_1 = __webpack_require__(/*! react-highlight-words */ "./node_modules/react-highlight-words/dist/main.js");
...
(function (AvorgMoleculeSearch) {
    function Search() {
        ...
        console.log(react_highlight_words_1.default);
        function loadSuggestions(input) {
            fetch("/wp-json/avorg/v1/suggestions?term=" + input)
                .then(function (res) { return res.json(); })
                .then(function (data) { return setSuggestions(data); });
        }
        return wp.element.createElement("form", { className: 'avorg-organism-search', action: "/" + window.avorg.query.language + "/search", method: 'GET' },
            ...
            wp.element.createElement("ul", null, suggestions.map(function (item, i) { return wp.element.createElement("li", { key: i },
                wp.element.createElement("a", { href: item.url, "data-relevance": item.relevance, "data-weight": item.weight },
                    wp.element.createElement(react_highlight_words_1.default, { searchWords: query.split(' '), textToHighlight: item.title, highlightClassName: 'avorg-organism-search__highlight' }),
                    wp.element.createElement("span", null, item.type))); })));
    }
